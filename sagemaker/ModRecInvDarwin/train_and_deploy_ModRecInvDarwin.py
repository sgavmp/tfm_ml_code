...
script_path = 'pycaret_sagemaker_ModRecInvDarwin.py'
instance_type = 'ml.c5.2xlarge'
data_folder = 's3://tfm-2021-darwinex/data/ModRecInvDarwin/'
job_name = 'ModRecInvDarwin'
endpoint_name = 'ModRecInvDarwin-endpoint'
