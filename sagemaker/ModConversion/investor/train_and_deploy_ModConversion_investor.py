...
script_path = 'pycaret_sagemaker_ModConversion_investor.py'
instance_type = 'ml.c5.2xlarge'
data_folder = 's3://tfm-2021-darwinex/data/ModConversion/investor/'
job_name = 'ModConversion-investor'
endpoint_name = 'ModConversion-investor-endpoint'
...
predicted = predictor.predict(
    {'user_currency': 'GBP', 'user_country': 58, 'start_mifid_days': 0, 'has_finished_mifid': 1, 'finish_mifid_days': 2,
     ...
     'first_trade_investor_account_demo_days': 9, 'days_until_conversion_or_today': 3, 'is_converted': 1})
